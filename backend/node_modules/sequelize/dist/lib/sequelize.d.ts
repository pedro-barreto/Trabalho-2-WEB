import * as DataTypes from 'sequelize/dist/lib/data-types';
import { HookReturn, Hooks, SequelizeHooks } from 'sequelize/dist/lib/hooks';
...
import {
  ...
  CreationAttributes,
  Attributes,
} from 'sequelize/dist/lib/model';
import { ModelManager } from 'sequelize/dist/lib/model-manager';
import { QueryInterface, QueryOptions, QueryOptionsWithModel, QueryOptionsWithType, ColumnsDescription } from 'sequelize/dist/lib/query-interface';
import QueryTypes = require('sequelize/dist/lib/query-types');
import { Transaction, TransactionOptions } from 'sequelize/dist/lib/transaction';
import { Cast, Col, DeepWriteable, Fn, Json, Literal, Where } from 'sequelize/dist/lib/utils';
import { ConnectionManager } from 'sequelize/dist/lib/connection-manager';
